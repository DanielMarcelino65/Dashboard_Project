...
##Função para truncar o texto do eixo X do grafico de barras
def truncate_text(text, max_length=30):
    if len(text) > max_length:
        return text[:max_length] + "..."
    return text

##Definição das opções dos dropdowns
...
##Callback e função do grafico de barras
@app.callback(
...
##Callback e função do grafico de barras2
@app.callback(
...
##Callback e função do grafico de pizza
@app.callback(
...
##Callback e função do grafico de pizza2
@app.callback(
